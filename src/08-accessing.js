...
let name1 = person.names.first
let name2 = person.names.middle
let name3 = person.names.last
...
function getCityAndState(person) {
  ...
  let state1 = person.address.state
  return `${city1}, ${state1}`
}
...
function getFullAddress(person) {
  let city1 = person.address.city
  let state1 = person.address.state
  let zip1 = person.address.zip
  let street1 = person.address.street
  let unit1 = person.address.unit

  return `${street1} ${unit1}, ${city1}, ${state1}, ${zip1}`
}
