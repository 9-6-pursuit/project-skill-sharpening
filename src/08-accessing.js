 ...
 */
function getFullName(person) {  return (person.names.first + " " + person.names.middle + " " + person.names.last )}
...
function getFlatObject(person) {
  let person1 = {
    ...
    numbers: person.numbers
     ...
     // person1.names.first + person.names.middle+ person.names.last+  person.address.street + person.address.unit + person.address.city + person.address.state + person.address.zip + person.numbers
     return person1
}
