...
// if text has character = true
if (text.includes(character)) {
  return true 
// else if text does not have character = false
} 
if (!text.includes(character))
  return false
}
 ...
 *  //> false
 */
// if number is even then returns true
function isEven(num) {
if(num % 2 === 0) {
  return true
}
// if number is odd then returns false
if(!num % 2 === 0) {
  return false
}
}
 ...
 *  //> true
 */
// if number is odd then returns true
function isOdd(num) {
  if(num % 2 === 1){
    return true
  }
// if number is even then returns false
    return false
  }
